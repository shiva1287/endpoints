...
public class ProductRestController {
	...
	@ApiOperation("Featches the details of specific product with a given id from Database")
	...
	@ApiOperation("Featches the details of specific product with a given manufacturer from Database")
	...
	@ApiOperation("Add the new product into a Database")
